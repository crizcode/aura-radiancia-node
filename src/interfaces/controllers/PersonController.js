...
module.exports = {
  ...
  async createUser(request) {
    ...
    // Treatment
    const user = await CreateUser(firstName, lastName,  userName, email, password, serviceLocator);
  ...
  async findUsers(request) {
    ...
    // Output
    return users.map(serviceLocator.personSerializer.serialize)
  },
  ...
  async getUser(request) {
    ...
    return serviceLocator.personSerializer.serialize(user);
  },
